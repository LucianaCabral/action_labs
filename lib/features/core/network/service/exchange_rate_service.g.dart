...
class _ExchangeRateService implements ExchangeRateService {
  ...
  Future<CurrentExchangeRateResponse> getCurrentExchangeRate({
    ...
    final _options = _setStreamType<CurrentExchangeRateResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late CurrentExchangeRateResponse _value;
    try {
      _value = CurrentExchangeRateResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
